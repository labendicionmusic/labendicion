...
const PRESS_QUOTES: { quote: string; source: string; url?: string }[] = [
  // TODO: llenar con fragmentos reales de prensa
  {
    quote: '"Una propuesta fresca que redefine la salsa contemporánea desde México."',
    source: 'Medio por confirmar',
  },
  {
    quote: '"La Bendición llega con un sonido que mezcla la nostalgia caribeña con la energía urbana actual."',
    source: 'Medio por confirmar',
  },
  {
    quote: '"Un debut de álbum que demuestra la madurez artística de un proyecto que ya venía construyendo su camino."',
    source: 'Medio por confirmar',
  },
];
    ...
    <div className="w-full min-h-screen bg-background text-on-background overflow-x-hidden selection:bg-primary selection:text-black">
      ...
      <footer className="w-full border-t border-white/10 bg-black py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            href="/"
            className="font-mono text-[10px] uppercase tracking-[0.3em] text-white/30 hover:text-white transition-colors"
          >
