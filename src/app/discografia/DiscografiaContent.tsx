        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              ...
              className="border border-outline-variant text-white px-10 py-5 font-mono text-xs uppercase tracking-[0.2em] font-black flex items-center gap-3 hover:bg-[#1DB954] hover:border-[#1DB954] hover:text-black transition-all duration-300"
            >
